...
|-------|--------|-----------|
| 2026-06-17 | — | Portal (AppPortal.jsx): volgorde Datavalidatie -> Uitvraag -> Datastation, alle knoppen 'Inloggen', Datastation geactiveerd (env VITE_DATASTATION_URL, fallback poort 5176 = AANNAME, te bevestigen). Uitvraag/Datastation-URL per omgeving via VITE_*. |
